...
class PostingsControllerTest < ActionController::TestCase
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post :create, posting: { accepted: @posting.accepted, description: @posting.description, name: @posting.name, url: @posting.url }
    end
  ...
  test "should update posting" do
    put :update, id: @posting, posting: { accepted: @posting.accepted, description: @posting.description, name: @posting.name, url: @posting.url }
    assert_redirected_to posting_path(assigns(:posting))
  end
